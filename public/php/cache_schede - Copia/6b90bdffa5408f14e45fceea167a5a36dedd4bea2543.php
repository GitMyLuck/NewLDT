...
<div class="scheda-news">
	...
	<div class="scheda-news-colonne sx">
		...
		<div id="titolo" class="scheda_news_titolo">TROFEO LUCCA DELTA TEAM</div><!--titolo-->
		<div id="super_cont" class="scheda_news_foto" style="display:block;"><img id="foto" src="public/php/immagini_eventi/1511171125-578C85EBBD86.jpg" alt="&nbsp; no immagine" title="foto"></div><!--foto-->
		<div class="scheda-dati">
			<div class="scheda_news_indirizzo"  style=" display:block"><b>Data :</b>&nbsp; &nbsp; 19/09/2010</div><!--data_evento-->
			<div class="scheda_news_indirizzo"  style=" display:block"><b>Gruppo Ospitante :</b>&nbsp; &nbsp; LuccaDeltaTeam</div><!--gruppo-->
			<div class="scheda_news_indirizzo" style=" display:block"><b>Località :</b>&nbsp;Aviosuperficie</div><!--localita-->
	...
	<div class="scheda-news-buttons dx">
				...
				<div id="data" class="scheda-btn first" >Data Evento 
					...
					<div class="data-btn">19/09/2010</div>
				</div><!--data_evento-->
...
﻿﻿						<ul class="cont-keys">#tags#</ul>
		...
		<!--			doc PDF					-->
		<div id="pdf-go" class="scheda-btn hoverable" style="display:block;">Scarica PDF 
				<div class="icona-btn pdf-btn"></div>
				<div class="cont-pdf"  style="visibility: hidden">pdf_eventi/1511171126-2EFA14F3CB08.pdf</div>
		</div><!--doc_pdf-->
		...
		<div id="fb-go" class="scheda-btn hoverable" onclick="return share(\'7\', \'eventi\');" >Condividi 
				<div class="icona-btn fb-btn"></div>
		</div><!-- NULL -->

		<!--		 condividi su FaceBook			-->
		<div id="return-go" class="scheda-btn hoverable" onclick="location.href = \'index.php\';" >Indietro
...
<hr><br>
<div class="scheda_news_descrizione"><strong  style="display:block">Una\'altra splendida manifestazione</strong><br>Dopo un sabato incerto,<br /><br />a tratti piovoso,<br /><br />è arrivato il giorno della gara.Alle 9,00 il direttore di gara, Carlo Ceragioli, fa partire i cronometri,il cielo comunque è sempre nuvoloso, anche se stiamo aspettando la schiarita promessa dalle previsioni del tempo segue...</div>
